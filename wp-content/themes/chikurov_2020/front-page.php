  ...
  <section class="seminars seminars_dark programm" id="programm">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <h5 class="age">После прохождения указанных сертификационных семинаров (всего 6 тем, 112 академических часов) и квалификационного экзамена слушателю школы выдается официальное свидетельство о подготовке в сфере оздоровление, которое дает право официально заниматься практикой - открыть ИП по ОКВЭДу 96.04 и вести оздоровительную деятельность.</h5>
        </div>
