    ...
    <div class="container chikurov_info">
      <div class="row">
        <div class="col-md-8 col-sm-8 col-xs-12">
          <h1 class="main_heading">Школа и творческая мастерская Доктора Чикурова</h1>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 text-center">
          <img class="chikurov_img" src="<?php bloginfo('template_url'); ?>/img/chi_for_site.jpg" alt="Чикуров Ю.В.">
        </div>
      </div>
    </div>
  ...
  <section class="seminars seminars_dark wizard" id="wizard">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <h5 class="animated_block hidden">Доступна помесячная оплата доступа к "WizardMachine", "WizardDuos" и "TarotMachine"</h5>
        </div>
