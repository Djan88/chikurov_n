  ...
  <section class="seminar text-center" id="seminar">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 seminar_type"><i class="fa fa-bookmark" aria-hidden="true"> </i> <?php get_field('seminar_type'); ?> <span class="seminar_timing"><i class="fa fa-clock-o" aria-hidden="true"> </i> <?php get_field('seminar_hours'); ?></span></div>
